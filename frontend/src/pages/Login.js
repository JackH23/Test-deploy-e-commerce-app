            ...
            <div className='grid'>
              ...
              <div className='bg-slate-100 p-2'>
                <input
                  ...
                  onChange={handleOnChange} // On change, update the state
            ...
            <div>
              ...
              <div className='bg-slate-100 p-2 flex'>
                <input
                  ...
                  name='password'
                  value={data.password} // Bind the input value to the email state
                  onChange={handleOnChange} // On change, update the state
                  className='w-full h-full outline-none bg-transparent'
                />
              ...
              <Link to={"/forgot-passowrd"} className='block w-fit ml-auto hover:underline hover:text-red-600'>
                Forgot password ?
              </Link>
            </div>
            {/* Login button */}
