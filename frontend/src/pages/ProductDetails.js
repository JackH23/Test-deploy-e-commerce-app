...
export const ProductDetails = () => {
  ...
  // console.log("productImageListLoading",productImageListLoading)
  ...
  const fetchProductDetails = async () => {
    ...
    const response = await fetch(SummaryApi.productDetails.url, {
      ...
      body: JSON.stringify({
        productId: params?.id  // Include the `productId` in the request body
      })
    });
    ...
    <div className='container mx-auto p-4'>
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
        ...
        <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
          ...
          {/* Thumbnails for additional product images */}
                    ...
                    return (
                      <div className='h-20 w-20 bg-slate-200 rounded p-1' key={imgURL}>
                        <img
                          ...
                          onMouseEnter={() => handleMouseEnterProduct(imgURL)}  // Change active image on hover
                          onClick={() => handleMouseEnterProduct(imgURL)}  // Change active image on click
                        />
                      </div>
                    );
                  })}
        ...
        {/*** Product Details ***/}
        {
          loading ? (
            <div className='grid gap-1 w-full'>
              <p className='bg-slate-200 animate-pulse h-16 lg:h-8 w-full inline-block'></p>
            ...
            <div className='flex flex-col gap-1'>
              ...
              {/* Buttons for buying or adding to cart */}
